      ...
      <div className=" flex flex-wrap justify-center mx-8">
        <div className="w-full md:w-1/4 mb-12 px-3">
          ...
          <div className="flex justify-around my-4 ">
            <a href="/" target="_blank" rel="noopener noreferrer" className="rounded-full w-auto bg-orange-600">
              <FaInstagram className="text-4xl p-2 text-white" />
            </a>
            <a href="/" target="_blank" rel="noopener noreferrer" className="rounded-full w-auto bg-green-600">
              <FaTwitter className="text-white text-4xl p-2" />
            </a>
            <a href="/" target="_blank" rel="noopener noreferrer" className="rounded-full w-auto bg-yellow-600">
              <FaFacebook className="text-4xl p-2 text-white" />
            </a>
            <a href="/" target="_blank" rel="noopener noreferrer" className="rounded-full w-auto bg-red-600">
        ...
        <div className="w-full md:w-1/4 mb-12">
          ...
          <a href="#" className="block mb-2 hover:text-gray-400">Creative Activity</a>
          <a href="#" className="block mb-2 hover:text-gray-400">Sports Activity</a>
          <a href="#" className="block mb-2 hover:text-gray-400">Water Activity</a>
          <a href="#" className="block mb-2 hover:text-gray-400">Play Activity</a>
          <a href="#" className="block hover:text-gray-400">Water</a>
        </div>
