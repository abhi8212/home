...
const testimonialData = [
  {
    ...
    pic:t1,
    name: 'John Doe',
    text: 'Tailwind CSS and Next.js are a powerful combination for creating responsive and efficient web applications. The ease of use and flexibility make development a breeze.',
  },
  {
    id: 2,
    pic:t1,
    name: 'Jane Smith',
    text: 'I’ve been using Tailwind CSS with Next.js and the slider feature for testimonials is fantastic. It allows me to showcase client feedback in an engaging and dynamic way.',
  },
  {
    id: 3,
    pic:t1,
...
const TestimonialSlider = () => {
  ...
  return (
    <div className='bg-gray-100 mr-7 w-auto pb-8 lg:ml-4 p-6 rounded-lg text-center'> 
    <div className="mb-7 justify-center text-center  py-9">
          ...
          Lets explore what Parents have to say about us. Let us know what you think of today’s newsletter and what you’d like to.
          </p>
